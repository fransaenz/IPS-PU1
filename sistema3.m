...
title('Modulo de la respuesta frecuencial H(e^{j2πs}) del Sistema 3', 'interpreter', 'latex');
...
title('Fase de la respuesta frecuencial  H(e^{j2πs}) del Sistema 3', 'interpreter', 'latex');;
